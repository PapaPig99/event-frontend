...
const emit = defineEmits(['update:modelValue', 'signup', 'signin'])
...
.modal-card{ position:relative; z-index:1; width:min(92vw,420px); background:#fff; border-radius:18px; padding:22px; box-shadow:0 25px 50px -12px rgba(0,0,0,.25); }
